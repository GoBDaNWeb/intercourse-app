...
export default function Message({message}) {
    return (
        <div className="flex items-start justify-start gap-2 w-full min-h-10 ">
            ...
            <div className="flex gap-2 items-end min-h-10 min-w-20 max-w-[70%] bg-white p-2 rounded-2xl shadow-custom">
                <div >
                    {message.message}
                </div>
