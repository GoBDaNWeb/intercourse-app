...
export default memo(function ThemePicker() {
    ...
    return (
        <>
                ...
                <div className='flex flex-wrap gap-2 text-center justify-center text-secondary'>
                    {
                        themeTypes.map((theme, index) => (
                            ...
                            >
                                <div className={`w-12 h-12 rounded-xl bg-chat-${theme} cursor-pointer border-2 border-solid border-gray-200 dark:border-gray-800`}></div>
                                <div className={`w-4 h-4 rounded-full transition-all duration-[0.3s] ${bgChat === theme ? 'bg-green-500' : 'bg-white'}`}></div>
                            </div>
                        ))
                    }
                </div>
            ...
            <div className='bg-chat-standart hidden'></div>
            <div className='bg-chat-galaxy hidden'></div>
            <div className='bg-chat-ocean hidden'></div>
            <div className='bg-chat-sunset hidden'></div>
            <div className='bg-chat-emerald hidden'></div>
        </>
    )
})