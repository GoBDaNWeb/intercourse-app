export default function PrivatChatImage({ chatData, size, text_size}) {
    return (
        <div 
        ...
        >
                {chatData && chatData.image ? (
                    <img
                    src={`https://bxnclqtavxncwdogrurd.supabase.co/storage/v1/object/public/image-privat-chats/${chatData.image}`}
                    alt="chatImage"
